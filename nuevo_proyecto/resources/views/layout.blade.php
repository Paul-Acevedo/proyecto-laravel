...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-skin-green elevation-1">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/SCO.jpeg" class="brand-image img-circle elevation-5"
           style="opacity: .8">
      <span class="brand-text font-weight-light">SECURE CONTRACT</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="https://adminlte.io">SECURE CONTRACT</a>.</strong> CONTRATOS A TU DISPOSICIÓN.
  </footer>
</div>
<!-- ./wrapper -->
